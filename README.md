...
> - To start using it, click **[Use this template](https://github.com/KnowHowDevOps/iqscaffold-ui-mantine-auth-portal/generate)** to create your new repository.
...
**Authenticated user operations** (change password, account settings, profile management) are handled by the main application portal at `app.iqkv.site`.
...
1. Click **[Use this template](https://github.com/KnowHowDevOps/iqscaffold-ui-mantine-auth-portal/generate)** button
...
git clone https://github.com/KnowHowDevOps/iqscaffold-ui-mantine-auth-portal.git my-app
...
> **Note:** Authenticated user operations (change password, logout all devices, email status) are handled by the main app portal at `app.iqkv.site`.
